 ...
 * @LastEditTime: 2024-07-01 02:58:06
 * @Description: 
...
void CountSensor_Init(void)
{
	...
	EXTI_InitTypeDef EXTI_InitStructure =
	{
		...
		/* 对射式红外传感器：接好VCC和GND，模块电源指示灯会亮，模块槽中无遮挡时，接收管导通，模块Do输出低电平，开关指示灯亮﹔有遮挡时，DO输出高电平，开关指示灯灭。
		对于上拉模式下的 GPIO 端口信号触发规则而言，开始遮挡时，GPIO从低电平到高电平，形成上升沿信号；移除遮挡时，GPIO信号从高电平到低电平，触发下降沿信号。
